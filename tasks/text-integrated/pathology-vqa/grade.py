...
def grade(submission: pd.DataFrame, answers: pd.DataFrame) -> float:
    ...
    # Exact match accuracy after lowering and stripping whitespace
    preds = submission["label"].astype(str).str.strip().str.lower()
    labels = answers["label"].astype(str).str.strip().str.lower()
