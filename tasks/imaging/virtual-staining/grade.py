import pandas as pd
from tasks.utils import grade_spearman
...
def grade(submission: pd.DataFrame, answers: pd.DataFrame) -> float:
    """Grade virtual staining prediction using Spearman rank correlation."""
    validate_first_column_match(submission, answers)
    return grade_spearman(
        submission, answers, id_col="id", pred_col="positive_ratio", target_col="positive_ratio"
    )
