...
LABEL_COLS = ["CYP3A4_inhibits", "CYP2D6_inhibits", "CYP2C9_inhibits", "CYP2C19_inhibits", "CYP1A2_inhibits"]
...
def grade(submission: pd.DataFrame, answers: pd.DataFrame) -> float:
    ...
    return grade_macro_roc_auc(
        submission, answers, id_col="id", label_cols=LABEL_COLS, missing_val=-1
    )
